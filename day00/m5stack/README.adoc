I'll use the https://m5stack.com/[M5Stack] to solve the puzzle on my arduino. The M5Stack I bought about one and a half year ago, was a suggestion from a colleague of mine, and I liked the concept, even if there are cheaper boards.
