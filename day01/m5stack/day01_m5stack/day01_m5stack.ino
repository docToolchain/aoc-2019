...
void setup() {
  ...
  M5.Lcd.println("We need the amount of modules");
  M5.Lcd.println("the mass for each modul.");

  for (int x = 0; x < i; x++) {
    fuel_counter_upper = fuel_counter_upper + mass[x] / 3 - 2;
  }
  M5.Lcd.println("the needed amount of fuel is:");
