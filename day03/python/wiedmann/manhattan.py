...
def compute(input_1, input_2):
    ...
    steps_cable_1 = []
    steps_cable_2 = []
    print("Extract steps from file")
    extract_steps(input_1, steps_cable_1)
    extract_steps(input_2, steps_cable_2)
    
    # put cables on board
    board = np.zeros([100000, 100000, 2], dtype=int)
    print("Putting cable 1 on board")
    [max_x_cable_1, max_y_cable_1, min_x_cable_1, min_y_cable_1] = walk_over_board(board, steps_cable_1, 0)
    print("Putting cable 2 on board")
    [max_x_cable_2, max_y_cable_2, min_x_cable_2, min_y_cable_2] = walk_over_board(board, steps_cable_2, 1)
    ...
    if debug:
        print("Common cable area ranges from x:", x_min, "to", x_max)
        print("Common cable area ranges from y:", y_min, "to", y_max)
...
def walk_over_board(board, steps, cable_id):
    x = 0
    y = 0
    max_x = -100000
    max_y = -100000
