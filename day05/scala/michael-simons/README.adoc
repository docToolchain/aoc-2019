...
TIP: I plan on getting https://twitter.com/kaffeecoder[Daniels] book https://leanpub.com/scala-from-scratch-exploration[Scala From Scratch]
      ...
      Daniel is one of the friendliest developers I know and I guess his books will be good, gentle introduction.
...
However, the underscore sticks it. What the? Turns out, a lot of ussages, see this https://stackoverflow.com/a/8001065[SO answer].
In the example above, it's just used as _Method values_.

It became appearant, that todays puzzle would add a lot of operators, so this time I wanted them to objects and I wanted to use https://docs.scala-lang.org/tour/case-classes.html[Case Classes] for them
...
The look funny… Both have two parameter lists, the first taking in the memory, the second one positional and mode respectivly positional and value parameter.
