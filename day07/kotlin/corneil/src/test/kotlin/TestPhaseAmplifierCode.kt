...
import com.github.corneil.aoc2019.day7.readProgram
...
class TestPhaseAmplifierCode {
    ...
    fun `test1`() {
        ...
        // when
        val output = phaseAmplifierTest(program, arrayOf(4, 3, 2, 1, 0).toIntArray())
        // then
    ...
    fun `test2`() {
        ...
        // when
        val output = phaseAmplifierTest(program, arrayOf(0, 1, 2, 3, 4).toIntArray())
        // then
        println("output = ${output}")
    ...
    fun `test3`() {
        ...
        // when
        val output = phaseAmplifierTest(program, arrayOf(1, 0, 4, 3, 2).toIntArray())
        // then
        println("output = ${output}")
    ...
    fun `test4`() {
        ...
        // when
        val output = phaseAmplifierFeedback(program, arrayOf(9,8,7,6,5).toIntArray())
        // then
        println("output = ${output}")
    ...
    fun `test5`() {
        ...
        // when
        val output = phaseAmplifierFeedback(program, arrayOf(9,7,8,5,6).toIntArray())
        // then
        println("output = ${output}")
