...
class IntcodeComputer {
  ...
  static void execute(BlockingQueue<Long> inputQueue, BlockingQueue<Long> outputQueue, String input) {
    new IntcodeComputer().interpret(inputQueue, outputQueue, input);
  }
